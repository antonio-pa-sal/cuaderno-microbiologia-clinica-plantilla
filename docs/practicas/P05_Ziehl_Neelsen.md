---
title: "P05 — Tinción de Ziehl-Neelsen"
practice_id: P05
...
reference_document: "práctica11_TincióndeZielh-Neelsen.pdf"
---
...
| Campo | Información |
|---|---|
| Código y título | `P05 — Tinción de Ziehl-Neelsen` |
...
| Agrupamiento | Observación, demostración o análisis de material docente en parejas; interpretación y registro individual. |
| Instrumentos vinculados | Prueba práctica de interpretación, cuaderno o portfolio de prácticas y caso clínico o profesional. |
...
- explicar qué caracteriza una tinción ácido-alcohol resistente;
- reconocer la secuencia general de la técnica y los puntos que condicionan su calidad;
- describir el aspecto microscópico esperado de una preparación teñida;
- interpretar controles, contraste y posibles artefactos;
...
1. Confirmar la modalidad segura: preparado fijado, imagen, resultado docente o demostración validada.
2. Revisar el objetivo de la tinción, los riesgos y las medidas de seguridad aplicables.
3. Si se muestra una demostración autorizada, identificar la función del colorante primario, la etapa de decoloración y el colorante de contraste, sin manipular reactivos fuera de las instrucciones recibidas.
4. Observar la preparación o imagen con la configuración microscópica indicada.
5. Registrar morfología, coloración, distribución, controles y posibles artefactos.
6. Clasificar la lectura como compatible o no compatible con una reacción ácido-alcohol resistente, justificando los límites de esa afirmación.
7. Limpiar el puesto y registrar la gestión de residuos o, si se empleó material docente, la devolución segura del recurso.

### Procedimiento específico

**[PNT](https://seimc.org/wp-content/uploads/2025/06/seimc-procedimientomicrobiologia9a.pdf) de referencia:** [SEIMC, procedimiento 9a: tinción de Ziehl-Neelsen](https://seimc.org/wp-content/uploads/2025/06/seimc-procedimientomicrobiologia9a.pdf)

1. Confirma preparación, kit de Ziehl-Neelsen, fichas de seguridad, control y microscopio; trabaja con EPI y material autorizado.
2. Identifica colorante primario, decolorante y contraste en la ficha; no prepares reactivos ni calientes fuera del [PNT](https://seimc.org/wp-content/uploads/2025/06/seimc-procedimientomicrobiologia9a.pdf).
3. Sigue la demostración respetando orden, tiempos y lavados validados; evita salpicaduras y contacto dérmico.
4. Observa con el objetivo indicado y registra bacilos coloreados, fondo, distribución y aumento.
5. Compara controles positivo y negativo; diferencia estructuras teñidas de precipitados, fibras o burbujas.
6. Clasifica la lectura como compatible, no compatible o no valorable; no conviertas el resultado en diagnóstico.
7. Elimina material y líquidos según residuos, limpia el puesto y registra origen, control e incidencias.

### Controles de calidad

- Modalidad segura y origen del material claramente identificados.
- Reactivos vigentes y FDS disponibles, si se realizó una demostración.
- Preparación o imagen con calidad suficiente para una lectura microscópica.
- Control positivo y control negativo, si están disponibles en el material docente, con el resultado esperado.
- Diferenciación entre estructura teñida, precipitado, burbuja y artefacto.
- Imagen o esquema con pie de foto técnico y origen declarado.
...
- **Modalidad realmente realizada:** [Preparado fijado/comercial / imagen diagnóstica / resultado docente / demostración autorizada / otra; descríbela]
...
- **Origen de la imagen:** [Observación propia de preparado seguro / material docente / imagen diagnóstica; especifica]
...
1. **Procedimiento:** ¿Qué condición de seguridad impediría realizar una demostración de la tinción y qué alternativa equivalente permitiría trabajar el aprendizaje sin asumir ese riesgo?

   [Respuesta del alumnado]

2. **Interpretación:** ¿Qué observaciones y controles necesitarías para considerar que una preparación es compatible con una reacción ácido-alcohol resistente? ¿Qué artefacto podría llevarte a una interpretación errónea?

   [Respuesta del alumnado]

3. **Conclusiones:** ¿Qué limitación impide pasar de una lectura microscópica compatible con BAAR a una identificación de especie o a un diagnóstico? Relaciónala con tus evidencias.

   [Respuesta del alumnado]

4. **Aprendizaje y transferencia:** ¿Qué principio de seguridad química, térmica o biológica trasladarás a futuras prácticas de tinción y cómo te ayudará a decidir cuándo ejecutar, observar una demostración o usar una alternativa documental?
